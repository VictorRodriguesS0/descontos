    ...
    >
      ...
      >
        {product.linkFoto && !photoError ? (
          ...
          <div className="d-flex flex-column justify-content-center h-100" style={{ color: 'lightgrey' }}>
        ...
        <div className="d-flex flex-row mt-3">
          {product.armazenamento && product.armazenamento.length && (
            <>
              ...
              />
              <span style={{
                color: colors.cinza, fontSize: 14, alignSelf: 'center', margin: '0px 20px 0px 10px',
              }}
              >
