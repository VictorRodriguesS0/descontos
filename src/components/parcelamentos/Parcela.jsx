    ...
    return (
      <div className="btn-darken" style={{backgroundColor: colors.roxo }}>
        <div className="d-flex flex-row justify-content-between align-content-center p-2 font-montserrat">
          ...
          <div className="d-flex flex-row">
            {numero === 0 ? (
              ...
              <>
                ...
                <span style={{ color: colors.roxoClaro, fontSize: isBrowser ? 27 : 20, alignSelf: 'center' }}>
          ...
          <span style={{ color: colors.amarelo, fontSize: isBrowser ? 27 : 20, }}>
            {moneyStringMask(parseFloat(valor))}
          </span>

        </div>
        <div style={{ width: '100%', borderTop: 'solid 1px', borderColor: colors.roxoClaro }} />
      </div>
    );
  }
}
