...
const MainScreen = (props) => {
  ...
  const routerRender = () => {
    ...
    if (path.match('^\\/lista\\/?$')) {
      return (
        <ListCategory
          onCategoryClick={(sectionPressed) => handleCategoryPress(sectionPressed)}
    ...
    if (path.match('^\\/lista\\/categoria.*')) {
      return (
        <ListProduct section={selectedSection} />
      );
    }
    ...
    <div style={{ paddingTop: 80 }}>
      ...
      <div className={isBrowser ? 'container' : ''}>
        <div className="d-flex flex-row mb-3">
          ...
          <div style={{ borderTop: 'solid 1px white', width: '100%', margin: 20 }} />
        </div>
